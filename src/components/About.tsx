...
export default function About() {
  ...
  return (
    <section id="about" className="py-16 sm:py-20 bg-[#14171e] border-t border-[#292e3a] relative overflow-hidden">
      
      {/* Background ambient accents */}
      <div className="absolute top-0 right-1/4 w-96 h-96 bg-[#a71d2a]/5 blur-[120px] rounded-full pointer-events-none" />
      <div className="absolute bottom-0 left-1/4 w-96 h-96 bg-[#b88655]/5 blur-[120px] rounded-full pointer-events-none" />
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10 space-y-20">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="relative rounded-2xl overflow-hidden border border-[#292e3a] bg-[#181b22] shadow-2xl p-6 sm:p-8 backdrop-blur-sm">
              ...
              <div className="grid grid-cols-2 gap-4 py-6 border-b border-[#292e3a]">
                ...
                <div className="p-4 rounded-xl bg-[#111317] border border-[#292e3a]">
                  ...
                  <span className="text-xs text-[#c6beb4]">شحن جوي سريع للعنوان</span>
                </div>
              </div>
          ...
          >
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#181b22] border border-[#292e3a] text-xs font-bold text-[#a71d2a]">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-2">
              ...
              <div className="flex items-center gap-3 p-3 rounded-xl bg-[#181b22] border border-[#292e3a]">
                <CheckCircle2 className="w-5 h-5 text-[#a71d2a] shrink-0" />
                <span className="text-xs sm:text-sm font-semibold text-neutral-200">خبراء فنيون متخصصون بالسيارات الألمانية</span>
              </div>
            </div>
        ...
        <div className="relative flex items-center justify-center">
          <div className="w-full border-t border-[#292e3a]" />
          <div className="absolute px-4 bg-[#14171e] text-xs font-bold text-[#b88655] uppercase tracking-wider flex items-center gap-2">
        ...
        <div>
          ...
          >
            ...
            <h3 className="text-2xl sm:text-4xl font-extrabold text-[#f4efea] mb-4">
            ...
            {features.map((feat, idx) => {
              ...
              return (
                ...
                >
                  ...
                  <h4 className="text-lg font-bold text-white mb-2.5 group-hover:text-[#b88655] transition-colors">
                    {feat.title}
                  </h4>
