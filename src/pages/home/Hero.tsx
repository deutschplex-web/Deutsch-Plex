    ...
    <section id="home" className="relative pt-24 pb-16 lg:pt-32 lg:pb-24 overflow-hidden min-h-[96vh] flex items-center justify-center">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="max-w-4xl mx-auto text-center mb-8">
          ...
          >
            استيراد فوري وشحن جوي سريع لقطع الغيار الأصلية (OEM) المعتمدة لسيارات <strong className="text-[#181b22] dark:text-[#f3f4f6]">بورش، بي إم دبليو، أودي، مرسيدس بنز، وفولكس واجن</strong>.
          </motion.p>
